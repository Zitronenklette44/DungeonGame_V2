	...
	public void checkCurrentObjects() {
	    ...
	    for (int i = 0;i < currentObjects.size();i++) {
	        ...
	        if (Object.pos.getVecX() + Object.size.width < -padding || Object.pos.getVecX() > Width + padding
	                || Object.pos.getVecY() + Object.size.height < -padding || Object.pos.getVecY() > Height + padding) {
...
//	    Collections.sort(currentObjects, Comparator.comparing(obj -> obj.pos.getVecZ())); // sort by z-axis for later drawing 			unused 
	}
	...
	public void drawObjects(Graphics2D g) {
	    ...
	    if (darkness) {
	        ...
	        BufferedImage darknessLayer = new BufferedImage(Screen.size.width, Screen.size.height, BufferedImage.TYPE_INT_ARGB);
	        ...
	        for (SimpleObject ob : drawLater) {
	            if (ob.isEmitting) {
	                ...
	                darknessGraphics.fillOval((int) (centerX - radius / 2),
